#ifndef __AG_INCLUDE_KERNEL_SPINLOCK_H__
#define __AG_INCLUDE_KERNEL_SPINLOCK_H__
 ...
 *
 * Spinlocks should be used if the holding time is short or if the data to be
...
#endif  // !__AG_INCLUDE_KERNEL_SPINLOCK_H__
