...
realview_storage_init(void)
{
  ...
  sd_init(&sd, &pl180_ops, &mmci, IRQ_MCIA);
...
realview_console_init(void)
{
  ...
  uart_init(&uart0, &pl011_ops, &pl011, IRQ_UART0);
