 ...
 */
static int
pl180_irq_enable(void *ctx)
{
  struct PL180 *pl180 = (struct PL180 *) ctx;
 ...
 */
static int
pl180_send_cmd(void *ctx, uint32_t cmd, uint32_t arg, int resp_type,
               uint32_t *resp)
{
  struct PL180 *pl180 = (struct PL180 *) ctx;
 ...
 */
static int
pl180_begin_transfer(void *ctx, uint32_t data_length, int direction)
{
  struct PL180 *pl180 = (struct PL180 *) ctx;
  uint32_t data_ctrl;
 ...
 */
static int
pl180_receive_data(void *ctx, void *buf, size_t n)
{
  struct PL180 *pl180 = (struct PL180 *) ctx;
 ...
 */
static int
pl180_send_data(void *ctx, const void *buf, size_t n)
{
  struct PL180 *pl180 = (struct PL180 *) ctx;
...
struct SDOps pl180_ops = {
  .begin_transfer = pl180_begin_transfer,
  .irq_enable = pl180_irq_enable,
  .receive_data = pl180_receive_data,
  .send_data = pl180_send_data,
