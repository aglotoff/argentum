...
int     tty_open(struct Request *, dev_t, int, mode_t);
ssize_t tty_read(struct Request *, dev_t, uintptr_t, size_t);
ssize_t tty_write(struct Request *, dev_t, uintptr_t, size_t);
int     tty_ioctl(struct Request *, dev_t, int, int);
int     tty_select(struct Request *, dev_t, struct timeval *);
void    tty_switch(int);
